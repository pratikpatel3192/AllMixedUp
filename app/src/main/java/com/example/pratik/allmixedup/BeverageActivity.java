...
import com.example.pratik.allmixedup.menuFragments.Beverages;
...
public class BeverageActivity extends Base{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_beverages);
        setSupportActionBar(toolbar);

        //Initializing the tablayout
        tabLayout = (TabLayout) findViewById(R.id.tabLayout_beverages);
        tabLayout.setTabGravity(TabLayout.GRAVITY_FILL);

        //Initializing viewPager
        viewPager = (ViewPager) findViewById(R.id.pager_beverages);
        Pager adapter = new Pager(getSupportFragmentManager());
        adapter.addpage(new Beverages());
